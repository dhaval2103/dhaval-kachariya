        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ asset('dist/img/bhole.jpg') }}" class="img-circle elevation-2"
                            alt="User Image">
                    </div>
                    <div class="info">
                        <a href="{{ route('admin.dashboard.index') }}" class="d-block">Dhaval Kachariya</a>
                    </div>
                </div>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.userdata') }}" class="nav-link">
                                ...
                                <p> &nbsp;User-Detail &nbsp;<i class="fas fa-arrow-circle-right"></i></p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.addrole') }}" class="nav-link">
                                <i class="fa fa-user-circle"></i>
                                <p> &nbsp;Create-Role &nbsp;<i class="fas fa-arrow-circle-right"></i></p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.showrole') }}" class="nav-link">
                                <i class="fa fa-user-circle"></i>
                                <p> &nbsp;View-Role &nbsp;<i class="fas fa-arrow-circle-right"></i></p>
                            </a>
                        </li>
