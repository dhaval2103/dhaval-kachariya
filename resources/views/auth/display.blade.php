...
<body class="antialiased">
    <div
        ...
        <button class="btn btn-light" style="margin-left: 1200px"><b
                style="color:black">{{ Auth::user()->name }}</b></button><br>
        <li class="nav-item d-none d-sm-inline-block">
            <button class="btn btn-light" style="margin-left: 1200px"><a href="{{ route('logout') }}"
        ...
        {{-- &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; --}}
        <button class="btn btn-light"><b><a href="{{ route('auth.dashboard') }}" style="color:black">Go To Dashboard
                    Click
                    Here....</a></b></button>
                ...
                <div class="row">
                    @foreach ($query as $querys)
                        <div class="card"
                            ...
                            <a href="{{ route('crud.displaycomment', ['id' => $querys->id]) }}">
                                <div class="card-body display" id="show">
                                    ...
                                    <div id="{{ $querys->id }}">
                                        ...
                                        <center><b style="color:rgb(95, 91, 91)">{{ $userInfo->name }}</b></center>
