        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <b>
                            <h1 class="m-0">View All User Blog Detail</h1>
                        </b>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('auth.display') }}">Home</a></li>
                            <li class="breadcrumb-item active">Dashboard v1</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
                                ...
                                <div id="{{ $querys->id }}">
                                    ...
                                    <div>
                                        <button type="button" class="btn btn-light view hvr" id="likeblog"
                                            ...
                                            <b class="count{{ $querys->id }}">{{ $count }}</b>
                                        </button>
                    ...
                    <div class="modal fade" id="exampleModalCenter3" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog modal-dialog-scrollable" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <input type="hidden" class="form-control userid" value="{{ Auth::user()->id }}">
    ...
    <script>
        ...
        $(document).on("click", '#likeblog', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success == 1) {
                        $('.count' + response.id).html(response.data);
                    } else {
                        $('.count' + response.id).html(response.data);
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $.each(response.query, function(key, value) {
                        ...
                        htm +=
                            "<b>Created_By : <span class='" + value.user_id +
                            "'></span></b><div class='form-group'><input class='form-control' type='text' class='col-sm-12' value=" +
                            value.comment +
                            " disabled><input class='form-control' type='text' class='col-sm-12' value=" +
                            time +
